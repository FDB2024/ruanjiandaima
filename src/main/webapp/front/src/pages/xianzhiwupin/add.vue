...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="物品名称" prop="wupinmingcheng">
            <el-input  v-model="ruleForm.wupinmingcheng" 
                placeholder="物品名称" clearable :readonly=" false  ||ro.wupinmingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="物品图片" v-if="type!='cross' || (type=='cross' && !ro.wupintupian)" prop="wupintupian">
            <file-upload
            tip="点击上传物品图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="物品图片" prop="wupintupian">
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="新旧程度" prop="xinjiuchengdu">
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="物品数量" prop="wupinshuliang">
            <el-input  v-model.number="ruleForm.wupinshuliang" 
                placeholder="物品数量" clearable :readonly=" false  ||ro.wupinshuliang"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="物品单价" prop="wupindanjia">
            <el-input type="number" v-model.number="ruleForm.wupindanjia" 
                placeholder="物品单价" clearable :readonly=" false  ||ro.wupindanjia"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="物品品牌" prop="wupinpinpai">
            <el-input  v-model="ruleForm.wupinpinpai" 
                placeholder="物品品牌" clearable :readonly=" false  ||ro.wupinpinpai"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="物品详情" prop="wupinxiangqing">
            <editor 
    ...
    data() {
      return {
        ...
        rules: {
          ...
          wupinpinpai: [
            { required: true, message: '物品品牌不能为空', trigger: 'blur' },
          ],
          wupinxiangqing: [
          ],
          discussnum: [
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='wupindanjia'){
              this.ruleForm.wupindanjia = obj[o];
              this.ro.wupindanjia = true;
              continue;
            }
            if(o=='wupinpinpai'){
        ...
        this.xinjiuchengduOptions = "全新,九成新,八成新,七成新".split(',')
      },

    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`xianzhiwupin/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('xianzhiwupin/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post(`xianzhiwupin/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
