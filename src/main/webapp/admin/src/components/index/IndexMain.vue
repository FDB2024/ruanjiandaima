	...
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (1 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","background":"#F0F1F3","display":"block"} : (1 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			...
			<template v-if="'vertical' == 'vertical'">
			  <template v-if="1 == 1">
				<index-aside :style='{"boxShadow":"1px 0 6px  rgba(64, 158, 255, .3)","bottom":"0","overflow":"hidden","top":"0","left":"0","background":"url(http://codegen.caihongy.cn/20231023/58103bab6e864fa79eb8b97b83d2c342.png)","width":"210px","fontSize":"0px","backgroundSize":"cover","position":"fixed","backgroundPosition":"center bottom","backgroundRepeat":"no-repeat","height":"100%","zIndex":"1001"}'></index-aside>
			  </template>
			  <template v-if="1 == 2">
