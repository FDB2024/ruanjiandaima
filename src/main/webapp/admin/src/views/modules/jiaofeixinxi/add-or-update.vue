		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="暖气费" prop="nuanqifei">
					<el-input  v-model="ruleForm.nuanqifei" placeholder="暖气费" clearable  :readonly="ro.nuanqifei"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="应缴费用" prop="yingjiaofeiyong">
					<el-input  v-model="ruleForm.yingjiaofeiyong" placeholder="应缴费用" clearable  :readonly="ro.yingjiaofeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="应缴费用" prop="yingjiaofeiyong">
